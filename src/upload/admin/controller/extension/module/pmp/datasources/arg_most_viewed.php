...
class ControllerExtensionModulePMPDataSourcesARGMostViewed extends ControllerExtensionModulePMPGroupsARG {

	private $_route = 'extension/module/pmp/datasources/arg_most_viewed';
