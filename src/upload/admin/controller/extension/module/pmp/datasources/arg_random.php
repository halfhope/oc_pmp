...
class ControllerExtensionModulePMPDataSourcesARGRandom extends ControllerExtensionModulePMPGroupsARG {

	private $_route = 'extension/module/pmp/datasources/arg_random';
