...
class ARGDiscussed extends \Opencart\Admin\Controller\Extension\Pmp\Module\Pmp\Groups\ARG {
  
	private $_route = 'extension/pmp/module/pmp/datasources/arg_discussed';
